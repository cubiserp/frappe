...
frappe.ui.misc.about = function () {
	...
	const dialog = new frappe.ui.Dialog({ title: __("CUBIS System") });

	$(dialog.body).html(
		`<div>
				<p>${__("A CUBIS System")}</p>

				<p>
					<i class='fa fa-globe fa-fw'></i>
					${__("Website")}:
					<a href='https://cubetiqs.com/' target='_blank'>https://cubetiqs.com/</a>
				</p>
				...
				<p class='text-muted'>${__("&copy; CUBIS Tech and contributors")} </p>
			</div>`
	);
